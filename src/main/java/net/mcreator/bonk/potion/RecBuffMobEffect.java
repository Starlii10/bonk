...
package net.mcreator.bonk.potion;
...
import net.mcreator.bonk.procedures.RecBuffOnEffectActiveTickProcedure;
import net.mcreator.bonk.procedures.RecBuffEffectStartedappliedProcedure;
