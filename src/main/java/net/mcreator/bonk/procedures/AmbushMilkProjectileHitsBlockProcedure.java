...
public class AmbushMilkProjectileHitsBlockProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		Direction randomdir = Direction.NORTH;
		for (int index0 = 0; index0 < (int) (30); index0++) {
			randomdir = Direction.getRandom(new Random());
			...
			} else if (randomdir == Direction.UP) {
				if (world instanceof ServerLevel _level) {
			...
			} else if (randomdir == Direction.NORTH) {
				if (world instanceof ServerLevel _level) {
