...
public class BonkerRenderer extends HumanoidMobRenderer<BonkerEntity, HumanoidModel<BonkerEntity>> {
	public BonkerRenderer(EntityRendererProvider.Context context) {
