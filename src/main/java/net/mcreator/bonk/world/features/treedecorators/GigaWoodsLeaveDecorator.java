...
public class GigaWoodsLeaveDecorator extends LeaveVineDecorator {
	public static final GigaWoodsLeaveDecorator INSTANCE = new GigaWoodsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("oh_god_what_have_i_done_tree_leave_decorator");
