...
import net.mcreator.bonk.world.features.plants.PizzaPlantFeature;
import net.mcreator.bonk.world.features.ores.MultiOreFeature;
import net.mcreator.bonk.world.features.lakes.MultiWaterFeature;
import net.mcreator.bonk.world.features.lakes.MilkyounerdFeature;
import net.mcreator.bonk.world.features.RecroomFeature;
import net.mcreator.bonk.world.features.AmogusFeature;
