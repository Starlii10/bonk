...
public class NyooommmRenderer extends HumanoidMobRenderer<NyooommmEntity, HumanoidModel<NyooommmEntity>> {
	public NyooommmRenderer(EntityRendererProvider.Context context) {
