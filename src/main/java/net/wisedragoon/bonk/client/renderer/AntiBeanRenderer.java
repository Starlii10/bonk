...
public class AntiBeanRenderer extends HumanoidMobRenderer<AntiBeanEntity, HumanoidModel<AntiBeanEntity>> {
	public AntiBeanRenderer(EntityRendererProvider.Context context) {
