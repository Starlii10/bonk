...
import net.wisedragoon.bonk.network.ComingSoonButtonMessage;
...
public class ComingSoonScreen extends AbstractContainerScreen<ComingSoonMenu> {
	...
	private static final ResourceLocation texture = new ResourceLocation("bonk:textures/coming_soon.png");
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "This page hasn't been implemented. Sorry!", 100, 46, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 145, this.topPos + 151, 108, 20, new TextComponent("Back to Debugger"), e -> {
			if (true) {
				BonkMod.PACKET_HANDLER.sendToServer(new ComingSoonButtonMessage(0, x, y, z));
