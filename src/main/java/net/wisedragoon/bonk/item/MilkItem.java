...
public class MilkItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(new TextComponent("The classic."));
		list.add(new TextComponent("Explodes and summons Beans on impact."));
	}
	...
	public void releaseUsing(ItemStack itemstack, Level world, LivingEntity entityLiving, int timeLeft) {
		if (!world.isClientSide() && entityLiving instanceof ServerPlayer entity) {
			...
			if (true) {
				MilkEntity entityarrow = MilkEntity.shoot(world, entity, world.getRandom(), 1f, 5, 1);
