...
import net.wisedragoon.bonk.procedures.UFOEntityDiesProcedure;
...
public class UFOEntity extends Monster {
	...
	public UFOEntity(EntityType<UFOEntity> type, Level world) {
		super(type, world);
		xpReward = 0;
		setNoAi(false);
	...
	public void die(DamageSource source) {
		...
		UFOEntityDiesProcedure.execute(world, x, y, z);
	}
