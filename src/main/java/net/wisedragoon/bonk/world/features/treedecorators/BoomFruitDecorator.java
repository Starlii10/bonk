...
public class BoomFruitDecorator extends CocoaDecorator {
	public static final BoomFruitDecorator INSTANCE = new BoomFruitDecorator();
	public static com.mojang.serialization.Codec<BoomFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("boom_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public BoomFruitDecorator() {
		super(0.2f);
	}
