...
package net.wisedragoon.bonk.world.features;
...
public class RecroomFeature extends Feature<NoneFeatureConfiguration> {
	public static final RecroomFeature FEATURE = (RecroomFeature) new RecroomFeature().setRegistryName("bonk:recroom");
	public static final ConfiguredFeature<?, ?> CONFIGURED_FEATURE = FEATURE.configured(FeatureConfiguration.NONE);
	public static final Set<ResourceLocation> GENERATE_BIOMES = null;
	private StructureTemplate template = null;

	public RecroomFeature() {
	...
	public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
		...
		if (!dimensionCriteria)
			return false;
		if (template == null)
			template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("bonk", "recroom"));
		if (template == null)
			return false;
