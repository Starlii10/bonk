...
import net.wisedragoon.bonk.entity.LaserGunEntity;
import net.wisedragoon.bonk.entity.IcyBoatEntity;
import net.wisedragoon.bonk.entity.GigaMilkEntity;
...
import net.wisedragoon.bonk.entity.AnActualMilkGunEntity;
...
public class BonkModEntities {
	...
	public static final EntityType<IcyBoatEntity> ICY_BOAT = register("icy_boat",
			EntityType.Builder.<IcyBoatEntity>of(IcyBoatEntity::new, MobCategory.MONSTER).setShouldReceiveVelocityUpdates(true).setTrackingRange(64)
					.setUpdateInterval(3).setCustomClientFactory(IcyBoatEntity::new).fireImmune().sized(0.6f, 1.8f));
	...
	public static void registerAttributes(EntityAttributeCreationEvent event) {
		...
		event.put(ICY_BOAT, IcyBoatEntity.createAttributes().build());
	}
}
