...
import net.wisedragoon.bonk.client.particle.RecRoomsParticle;
...
public class BonkModParticles {
	private static final Map<ParticleType<?>, Function<SpriteSet, ParticleProvider<SimpleParticleType>>> REGISTRY = new HashMap<>();
	public static final SimpleParticleType REC_ROOMS = register(new SimpleParticleType(false).setRegistryName("rec_rooms"),
			RecRoomsParticle::provider);
