...
import net.wisedragoon.bonk.procedures.NetherCommandExecutedProcedure;
...
public class NethercommandCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(Commands.literal("nether")
				...
				.then(Commands.argument("arguments", StringArgumentType.greedyString()).executes(NethercommandCommand::execute))
				.executes(NethercommandCommand::execute));
	}
